...
if ($_SERVER["REQUEST_METHOD"] != "POST") {
	eLog("REQUEST_METHOD is not POST!", $LogFile);
	print(1);
	return;
}
...
if (strcmp($_POST["mark"], $MARK) != 0) {
	$str = "Mark is Invalid!(".$_POST["mark"].")";
	eLog($str, $LogFile);
	print(1);
	return;
}
...
//print_r($timeMatrix);
// 実時間csvファイル出力
$file = "../data/".$sysCd."_realTime_".preg_replace("/-/", "", $reportDay).".csv";
$fp = fopen($file, "w");
flock($fp, LOCK_EX);
